...
class FixedBackground:
    ...
    def update(self):
        ...
        self.window_bottom=clamp(0,int(self.set_center_object.y)-self.canvas_height//2,self.h-self.canvas_height)
        pass

    def handle_event(self, event):
        pass

    def get_window_in_ball_left_bottom(self):
